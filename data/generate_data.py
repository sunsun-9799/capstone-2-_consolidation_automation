...
BASE = {
    "P": {
        "현금및현금성자산": 2000, "매출채권": 300, "재고자산": 1200, "대여금": 0,
        "유형자산": 3000, "종속기업투자주식": 3700, "매입채무": 400, "차입금": 300,
        "자본금": 5000, "이익잉여금": 4000,
        "매출": 2500, "매출원가": 1500, "판관비": 500, "배당금수익": 0,
    },
    "A": {
        "현금및현금성자산": 800, "매출채권": 200, "재고자산": 600, "대여금": 0,
        "유형자산": 1000, "종속기업투자주식": 0, "매입채무": 250, "차입금": 100,
        "자본금": 1000, "이익잉여금": 900,
        "매출": 1750, "매출원가": 1100, "판관비": 300, "배당금수익": 0,
    },
    "B": {
        "현금및현금성자산": 860, "매출채권": 300, "재고자산": 700, "대여금": 0,
        "유형자산": 1200, "종속기업투자주식": 0, "매입채무": 300, "차입금": 150,
        "자본금": 1500, "이익잉여금": 1060,
        "매출": 1700, "매출원가": 1300, "판관비": 350, "배당금수익": 0,
    },
}
...
def validate():
    ...
    used_codes = set(journal_df["회사코드"]) | set(journal_df["TradingPartner"]) | \
